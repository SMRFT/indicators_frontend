...
const Pharmacy = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    totalNumberOfSafeAndRationalPrescriptions: "",
    totalNumberOfSafeAndRationalPrescriptionsRemarks: "",
    totalNumberOfPrescriptionsAudited: "",
    totalNumberOfPrescriptionsAuditedRemarks: "",
    totalNumberOfPrescriptionInCapitalLetters: "",
    totalNumberOfPrescriptionInCapitalLettersRemarks: "",
    totalNumberOfPrescriptions: "",
    totalNumberOfPrescriptionsRemarks: "",
    totalNumberOfMedicationErrors: "",
    totalNumberOfMedicationErrorsRemarks: "",
    totalNumberOfOpportunitiesOfMedicationErrors: "",
    totalNumberOfOpportunitiesOfMedicationErrorsRemarks: "",
    numberOfPatientsDevelopingAdverseDrugReactions: "",
    numberOfPatientsDevelopingAdverseDrugReactionsRemarks: "",
    numberOfInPatients: "",
    numberOfInPatientsRemarks: "",
  });
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        ...
        const response = await fetch(
          "https://indicators.shinovadatabase.in/Pharmacy/",
          {
            method: "POST",
            headers: {
  ...
  return (
    <StyledContainer className="NumericalData">
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          <Col sm="8">
            <Form.Group controlId="totalNumberOfSafeAndRationalPrescriptions">
              <Form.Label>
              ...
              <Form.Control
                required
                type="text"
                value={formData.totalNumberOfSafeAndRationalPrescriptions}
                onChange={handleChange}
              />
              <Form.Control.Feedback type="invalid">
                Please fill out this field
          ...
          <Col sm="4">
            <Form.Group controlId="totalNumberOfSafeAndRationalPrescriptionsRemarks">
              <Form.Label>Remarks</Form.Label>
              <Form.Control
                required
                as="textarea"
                rows={1} // Adjust the number of visible rows
                value={
                  formData.totalNumberOfSafeAndRationalPrescriptionsRemarks
                }
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
        ...
        <Row className="mb-3">
          <Col sm="8">
            <Form.Group controlId="totalNumberOfPrescriptionsAudited">
              <Form.Label>Total Number Of Prescriptions Audited</Form.Label>
              <Form.Control
                required
                type="text"
                value={formData.totalNumberOfPrescriptionsAudited}
                onChange={handleChange}
              />
              <Form.Control.Feedback type="invalid">
                Please fill out this field
          ...
          <Col sm="4">
            <Form.Group controlId="totalNumberOfPrescriptionsAuditedRemarks">
              <Form.Label>Remarks</Form.Label>
              <Form.Control
                required
                as="textarea"
                rows={1} // Adjust the number of visible rows
                value={formData.totalNumberOfPrescriptionsAuditedRemarks}
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
                    e.preventDefault(); // Prevent form submission if applicable
        ...
        <Row className="mb-3">
          ...
          <Col sm="4">
            <Form.Group controlId="totalNumberOfPrescriptionInCapitalLettersRemarks">
              <Form.Label>Remarks</Form.Label>
              <Form.Control
                required
                as="textarea"
                rows={1} // Adjust the number of visible rows
                value={
                  formData.totalNumberOfPrescriptionInCapitalLettersRemarks
                }
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
        ...
        <Row className="mb-3">
          <Col sm="8">
            <Form.Group controlId="totalNumberOfPrescriptions">
              <Form.Label>Total Number Of Prescriptions</Form.Label>
              <Form.Control
                required
                type="text"
                value={formData.totalNumberOfPrescriptions}
                onChange={handleChange}
              />
              <Form.Control.Feedback type="invalid">
                Please fill out this field
          ...
          <Col sm="4">
            <Form.Group controlId="totalNumberOfPrescriptionsRemarks">
              <Form.Label>Remarks</Form.Label>
              <Form.Control
                required
                as="textarea"
                rows={1} // Adjust the number of visible rows
                value={formData.totalNumberOfPrescriptionsRemarks}
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
                    e.preventDefault(); // Prevent form submission if applicable
        ...
        <Row className="mb-3">
          ...
          <Col sm="4">
            <Form.Group controlId="totalNumberOfOpportunitiesOfMedicationErrorsRemarks">
              <Form.Label>Remarks</Form.Label>
              <Form.Control
                required
                as="textarea"
                rows={1} // Adjust the number of visible rows
                value={
                  formData.totalNumberOfOpportunitiesOfMedicationErrorsRemarks
                }
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
        ...
        <Row className="mb-3">
          ...
          <Col sm="4">
            <Form.Group controlId="numberOfInPatientsRemarks">
              <Form.Label>Remarks</Form.Label>
              <Form.Control
                required
                as="textarea"
                rows={1} // Adjust the number of visible rows
                value={formData.numberOfInPatientsRemarks}
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
                    e.preventDefault(); // Prevent form submission if applicable
