    ...
    if (form.checkValidity() === false) {
      ...
      try {
        ...
        const response = await fetch(
          "https://indicators.shinovadatabase.in/FirstFloor/",
          {
            method: "POST",
            headers: {
  ...
  return (
    <StyledContainer className="NumericalData">
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          <Col>
            <Form.Group controlId="sumOfTimeTakenForDischargeInsurance">
              <Form.Label>
                Sum of Time Taken for Discharge(Minutes)(Insurance)
              </Form.Label>
              <Form.Control
                type="text"
        ...
        <Row className="mb-3">
          <Col>
            <Form.Group controlId="sumOfTimeTakenForDischargePay">
              <Form.Label>
                Sum of Time Taken for Discharge(Minutes)(Pay)
              </Form.Label>
              <Form.Control
                type="text"
        ...
        <Row className="mb-3">
          <Col sm>
            <Form.Group controlId="numberOfPatientsDevelopingAdverseDrugReactions">
              <Form.Label>
                Number of Patients Developing Adverse Drug Reaction's
              </Form.Label>
              <Form.Control
                type="text"
        ...
        {Array.from({ length: formData.numberOfUnitsTransfused || 0 }).map(
          (_, index) => (
        ...
        <Row className="mb-3">
          <Col>
            <Form.Group controlId="numberOfRestraintInjuriesOrStrangulation">
              <Form.Label>
                Number of Restraint Injuries /Strangulatio
              </Form.Label>
              <Form.Control
                type="text"
        ...
        <Row className="mb-3">
          <Col>
            <Form.Group controlId="totalNumberOfPatientWhoDevelopsphlebitisOrExtravasation">
              <Form.Label>
                Total No of patient who develops phlebitis/Extravasation
              </Form.Label>
              <Form.Control
                type="text"
                value={
                  formData.totalNumberOfPatientWhoDevelopsphlebitisOrExtravasation
                }
                onChange={handleChange}
                required
              />
          ...
          <Col>
            <Form.Group controlId="totalNumberOfPatientWhoDevelopsphlebitisOrExtravasationRemarks">
              ...
              <Form.Control
                ...
                rows={1} // Adjust the number of visible rows
                value={
                  formData.totalNumberOfPatientWhoDevelopsphlebitisOrExtravasationRemarks
                }
                onChange={handleChange}
                onKeyDown={(e) => {
                  if (e.key === "Enter" && !e.shiftKey) {
        ...
        <Row className="mb-3">
          <Col>
            <Form.Group controlId="numberOfParenteralExposures">
              <Form.Label>
                Number of Parenteral Exposures (Injury due to any sharp)
              </Form.Label>
              <Form.Control
                type="text"
